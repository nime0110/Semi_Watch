...
public class Purchase_byMonth_JSON extends AbstractController {

	private js_5_ProductDAO pdao = null;
	
	public Purchase_byMonth_JSON() {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if(!"admin".equals(userid)) {
         ...
         // 로그인을 했을 경우
            ...
            List<Map<String, String>> Purchase_map_List = pdao.Purchase_byMonth(userid);
