...
import member.model.js_5_MemberDAO;
import member.model.js_5_MemberDAO_imple;
import shop.model.js_5_ProductDAO;
import shop.model.js_5_ProductDAO_imple;

public class Purchase_byMonthvisit_JSON extends AbstractController {

	private js_5_MemberDAO mdao = null;
	
	public Purchase_byMonthvisit_JSON() {
	      mdao = new js_5_MemberDAO_imple();
	}
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
      ...
      if(!"admin".equals(userid)) {
       ...
       // 로그인을 했을 경우
          ...
          List<Map<String, String>> Purchase_map_List = mdao.Purchase_byMonthvisitCnt(userid);
          ...
          if(Purchase_map_List.size() > 0) {
              ...
              for(Map<String, String> map : Purchase_map_List) {
                 ...
                 JSONObject json_obj = new JSONObject();
                   ...
                   json_obj.put("totalvist_cnt", map.get("totalvist_cnt"));
