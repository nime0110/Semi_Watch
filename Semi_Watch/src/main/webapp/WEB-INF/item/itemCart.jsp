...
<script type="text/javascript" src="test_cart.js"></script>
    ...
    <div class="row">
            ...
            <div class="row border-top border-bottom">
                <div class="row main align-items-center">
                    ...
                    <div class="col">
                     ...
                     <div class="col">&euro;<span class="item-price" id="price1">0.00</span>
                     <button>&#10005;</button></div>
                </div>
            </div>
            <div class="row">
                <div class="row main align-items-center">
                    ...
                    <div class="col">&euro;<span class="item-price" id="price2">0.00</span> 
                    <button>&#10005;</button></div>
                </div>
            </div>
            <div class="row border-top border-bottom">
                <div class="row main align-items-center">
                    ...
                    <div class="col">&euro;<span class="item-price" id="price3">0.00</span>
                    <button>&#10005;</button></div>
                </div>
            </div>
        ...
        <div class="col-md-4 summary">
            ...
            <div class="row">
                ...
                <div class="col text-right" id="sumprice">&euro; 132.00</div>
            </div>
            <form>
                <p>SHIPPING</p>
            ...
            <div class="row" style="border-top: 1px solid rgba(0,0,0,.1); padding: 2vh 0;">
                <div class="col" id="totalprice">TOTAL PRICE</div>
                <div class="col text-right">&euro; 137.00</div>
            </div>
            <button class="btn" id="go_Pay">CHECKOUT</button>
        </div>
    </div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
   ...
   /*
    const sumPrice = function(){
    	...
    	let sum = 0;
    	document.querySelectorAll("span.item-price").forEach((elmt)=>{
            sum += Number(elmt.innerText.split(",").join(""));
        });
    	
    	document.querySelector("div#sumprice).innerHTML = sum.toLocaleString('en');
    }
   */
