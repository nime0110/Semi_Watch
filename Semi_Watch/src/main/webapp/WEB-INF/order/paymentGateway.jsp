	...
	if(window.opener && !window.opener.closed){
		...
		//	여기 링크를 꼭 참고하세용 http://www.iamport.kr/getstarted
	   	...
	   	IMP.request_pay({
		    ...
		    amount : 200,	  // *** '${coinmoney}'  결제 금액 number 타입. 필수항목. 
		...
		*/
			...
			*/
			...
			//	opener.location.href = "javascript:goCoinUpdate('ctxPath 값','${idx}','${coinmoney}');";
				...
				isPaymentchck = true;
				// 부모창에 있는 함수를 불러온다.
				window.opener.checkOutUpdate('<%= ctxPath%>','${requestScope.userid}', isPaymentchck);
        ...
        window.location.href = "<%= ctxPath %>/login/login.flex";
	}
